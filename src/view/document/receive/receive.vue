<template>
  <div>
    <el-tabs class="top-sec-tab" v-model="activeName">
      <el-tab-pane label="待收任务" name="-1"></el-tab-pane>
      <el-tab-pane label="已收任务" name="1"></el-tab-pane>
    </el-tabs>
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <template v-else-if="scope.$index%3==1">
                <el-button @click="doFormDetail(scope.row)" type="text">收文</el-button>
              </template>
            </template>
          </el-table-column>
        </el-table>
